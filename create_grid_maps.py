...
def create_grid_maps_for_zs0(haloID):
    data = Table()
    ...
    data.write('./outputs/' + haloID + '_' + str(inp.zs0) + '_gmaps.hdf5',
                       path="/grid_maps", append=True, overwrite=True)#, compression=True)
...
if __name__ == '__main__':
    ...
    create_grid_maps_for_zs0(halo_id)
